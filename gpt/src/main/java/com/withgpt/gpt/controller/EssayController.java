...
public class EssayController {
    ...
    public EssayController(PostService postService, CommentService commentService) {
    ...
    public String listPosts(Model model, @RequestParam(name = "page", defaultValue = "0") int page) {
        ...
        Page<Post> posts = postService.getPostsByCategory(PostCategory.ESSAY, pageable);
